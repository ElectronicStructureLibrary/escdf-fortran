...
module escdff_common
    ...
    ! Add new definitions into ~escdf/src/escdf_common.h instead
    !%%% BEGIN ESCDF CONSTANTS
    integer(c_int), parameter, public :: ESCDF_STRLEN_ERROR = 1024
