...
!!
!! This file is part of Libescdf.
!!
!! Libescdf is free software: you can redistribute it and/or modify it under
!! the terms of the GNU Lesser General Public License as published by the Free
!! Software Foundation, version 3 of the License, or (at your option) any later
!! version.
!!
!! Libescdf is distributed in the hope that it will be useful, but WITHOUT ANY
!! WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS
!! FOR A PARTICULAR PURPOSE.  See the GNU Lesser General Public License for
!! more details.
!!
!! You should have received a copy of the GNU Lesser General Public License
!! along with Libescdf.  If not, see <http://www.gnu.org/licenses/> or write to
...
&     // ch10 // "      value error: bad value found (ESCDF_EVALUE)" // ch10
    ...
    call escdff_error_free()
    err_code = &
&     escdff_error_add(err_refcode, err_file, 1234, err_func)
    err_msg = escdff_error_fetchall()
  ...
  subroutine test_error_get_last()
    ...
    call escdff_error_free()
    err_code1 = &
&     escdff_error_add(err_refcode1, err_file1, err_line1, err_func1)
    err_code2 = &
&     escdff_error_add(err_refcode2, err_file2, err_line2, err_func2)
    err_code3 = &
&     escdff_error_add(err_refcode3, err_file3, err_line3, err_func3)

    call assert_equals(3, escdff_error_len(), &
...
&     escdff_error_get_last(err_func1), "Last error - Function 1")
...
&     escdff_error_add(err_refcode1, err_file1, err_line1, err_func1)
    ...
    call assert_equals(1, escdff_error_len(), &
&     "Single error - Chain length")
    call assert_equals(err_refcode1, err_code1, "Single error - Insertion")
    call assert_equals(err_refcode1, escdff_error_get_last(err_func1), &
...
&     "Triple error - Chain length")
    ...
    call assert_equals(err_refcode1, &
&     escdff_error_get_last(err_func1), "Triple error - Function 1")
    call assert_equals(err_refcode2, err_code2, "Triple error - Insertion 2")
    call assert_equals(err_refcode2, &
&     escdff_error_get_last(err_func2), "Triple error - Function 2")
    call assert_equals(err_refcode3, err_code3, "Triple error - Insertion 3")
    call assert_equals(err_refcode3, &
&     escdff_error_get_last(err_func3), "Triple error - Function 3")
